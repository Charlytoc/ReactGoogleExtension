export const SVGS = {
  ...
  list: (
    <svg
      ...
      className="with-stroke"
    >
      <path d="M3 1H1V3H3V1Z" fill="var(--font-color)" />
      <path d="M3 5H1V7H3V5Z" fill="var(--font-color)" />
      <path d="M1 9H3V11H1V9Z" fill="var(--font-color)" />
      <path d="M3 13H1V15H3V13Z" fill="var(--font-color)" />
      <path d="M15 1H5V3H15V1Z" fill="var(--font-color)" />
      <path d="M15 5H5V7H15V5Z" fill="var(--font-color)" />
      <path d="M5 9H15V11H5V9Z" fill="var(--font-color)" />
      <path d="M15 13H5V15H15V13Z" fill="var(--font-color)" />
    </svg>
  ),
  random: (
    <svg
